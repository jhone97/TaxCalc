namespace TaxApp.UI
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // buttonSubmit
            // 
            buttonSubmit.Location = new Point(38, 1037);
            buttonSubmit.Name = "buttonSubmit";
            buttonSubmit.Size = new Size(331, 129);
            ...
            Controls.Add(textBoxSubcharge);
            Controls.Add(textBoxDeductions);
            Controls.Add(labelSubcharge);
            Controls.Add(labelLocation);
            Controls.Add(labelDeductions);
            Controls.Add(textBoxSex);
            Controls.Add(textBoxHRA);
            Controls.Add(label);
            Controls.Add(labelHRA);
            Controls.Add(textBoxAge);
            Controls.Add(textBoxDA);
            Controls.Add(labelAge);
            Controls.Add(labelDA);
        ...
        private Label labelDA;
        private TextBox textBoxDA;
        private Label labelHRA;
        private TextBox textBoxHRA;
        private Label labelDeductions;
        private TextBox textBoxDeductions;
        private Label labelAllowance;
        private TextBox textBoxAllowance;
        private Label labelSubcharge;
        private TextBox textBoxSubcharge;
